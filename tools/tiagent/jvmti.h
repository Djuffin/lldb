...
/*
 * NOTE: the inclusion of the jvmti header in the agent is temporary as
 * it is currently not available as part of the NDK. Original source:
 *  /platform/art/runtime/openjdkjvmti/jvmti.h
 */
